<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_station.aspx.cs" Inherits="RailwayTicketWebsite.User.edit_station" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txtStationId" runat="server" CssClass="form-control read-only" ReadOnly="true"></asp:TextBox>
            </div>
            ...
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="revStationCode" runat="server" ControlToValidate="txtStationCode" ValidationExpression="^[A-Z]{3}$" ErrorMessage="Invalid Station Code. It should be 3 uppercase letters." ForeColor="Red" />
            </div>
            ...
            <div class="form-group">
                ...
                <asp:RequiredFieldValidator ID="rfvLineId" runat="server" ControlToValidate="ddlLineId" InitialValue="0" ErrorMessage="Line is required" ForeColor="Red" />
            </div>
