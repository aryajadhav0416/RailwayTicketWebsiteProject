<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_lineslab.aspx.cs" Inherits="RailwayTicketWebsite.User.edit_lineslab" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <h1>Edit Line Slab</h1>
            <div class="form-group">
                <label for="lineId">Line ID:</label>
                <asp:TextBox ID="txtLineId" runat="server" CssClass="form-control read-only" ReadOnly="true"></asp:TextBox>
            </div>
            <div class="form-group">
