<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_fareslab.aspx.cs" Inherits="RailwayTicketWebsite.User.add_fareslab" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Add Fare Slab</title>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="note">
                <p><u>Note</u> :<br />
                    <b>Ensure all fields are correctly filled before saving.</b></p>
            </div>
